...
// changed QD Shadows
geBoolean DRIVERCC RenderStencilPoly(DRV_XYZVertex *Pnts, int32 NumPoints, uint32 Flags);// {return GE_TRUE;}
geBoolean DRIVERCC DrawShadowPoly(geFloat r, geFloat g, geFloat b, geFloat a);// {return GE_TRUE;}
// end change
